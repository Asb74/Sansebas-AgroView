...
PRODUCTION_PERSONAL_HELP = {
    ...
    "personal_directo": {"title": "Personal directo disponible", "description": "Calculado desde áreas Directo. Personal que trabaja físicamente en la línea.", "example": "Tría, Mallas, Encajado o Loteado.", "impact": "Determina la capacidad productiva directa."},
    "personal_soporte": {"title": "Personal soporte disponible", "description": "Calculado desde áreas Soporte. Personal necesario para que la línea funcione.", "example": "Volcado, Alimentación, Calidad, Expedición o Mantenimiento.", "impact": "Permite medir los apoyos operativos necesarios para sostener el flujo productivo."},
    "personal_indirecto": {"title": "Personal indirecto disponible", "description": "Calculado desde áreas Indirecto. Personal no asignado directamente a una línea.", "example": "Encargados o Carretilleros.", "impact": "Permite detectar necesidades no vinculadas a una línea concreta."},
    ...
    "tipo_personal": {"title": "Tipo personal", "description": "Clasificación del área como Directo, Soporte o Indirecto. Directo trabaja físicamente en la línea; Soporte permite que la línea funcione; Indirecto no está asignado directamente a una línea.", "example": "Tría = Directo; Alimentación = Soporte; Encargados = Indirecto.", "impact": "Al cambiarlo se recalculan automáticamente los totales del resumen."},
...
PRODUCTION_PERSONAL_HELP_KEYS = ["personal_total", "personal_directo", "personal_soporte", "personal_indirecto", "horas_por_persona", "ausencias_previstas", "area", "tipo_personal", "disponible", "minimo_operativo", "optimo", "activo", "observaciones"]
