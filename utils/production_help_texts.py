...
PRODUCTION_CAPACITY_MASTERS_HELP = {
    ...
    "area_requerida": {"title": "Área requerida", "description": "Nombre del puesto solicitado por el flujo o la línea; es el destino que se necesita cubrir.", "example": "Volcado.", "impact": "Punto de partida para resolver disponibilidad equivalente."},
    "area_personal": {"title": "Área personal", "description": "Área real del maestro Personal que puede cubrir el área requerida; es el origen disponible.", "example": "Alimentación puede cubrir Volcado registrando área requerida=Volcado y área personal=Alimentación.", "impact": "Permite sumar nombres equivalentes sin introducir polivalencia."},
    "prioridad": {"title": "Prioridad", "description": "Orden de uso de la polivalencia o de aplicación/visualización de una equivalencia.", "example": "1.", "impact": "Mantiene trazabilidad cuando hay varias equivalencias o reglas de cobertura."},
    "puesto_origen": {"title": "Puesto origen", "description": "Puesto que aporta personal.", "example": "Carretillero.", "impact": "Identifica el origen disponible para cubrir necesidades alternativas."},
    "puesto_destino": {"title": "Puesto destino", "description": "Puesto que puede ser cubierto.", "example": "Volcado.", "impact": "Identifica la necesidad que se puede cubrir mediante polivalencia."},
    "factor_productividad": {"title": "Factor productividad", "description": "Porcentaje de rendimiento esperado.", "example": "85.", "impact": "Permite ponderar la cobertura cuando el personal trabaja fuera de su puesto principal."},
    "observaciones": {"title": "Observaciones", "description": "Comentarios operativos.", "example": "Configuración base de campaña.", "impact": "Documenta criterios de planta sin cambiar lógica."},
...
PRODUCTION_CAPACITY_MASTERS_HELP_KEYS = ["codigo", "descripcion", "orden", "activa", "linea_productiva", "familia_productiva", "puesto_productivo_principal", "modo_uso_recursos", "usar_capacidad_agregada", "recurso_codigo", "obligatorio", "modo_uso", "reparte_kg", "activo", "area_requerida", "area_personal", "puesto_origen", "puesto_destino", "prioridad", "factor_productividad", "observaciones", "updated_at"]
